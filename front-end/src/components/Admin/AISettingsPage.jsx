...
const DEFAULT = {
  ...
  maxTokens: 2048,
  prompt:
    "You are a helpful AI learning assistant. Guide users through their course materials with clear, concise explanations.",
};
      ...
      <div className="admin-body">
        <div className="a-card mb-3">
          <div className="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom">
            ...
            <div>
              ...
              <div style={{ fontSize: 13, color: "#94a3b8" }}>
                Configure the AI model used across the platform
              </div>
            </div>
          </div>

          <Form.Group className="mb-4">
            <Form.Label className="setting-label d-block mb-2">
              AI Model
            </Form.Label>
            <Form.Select
          ...
          <div className="d-flex justify-content-end align-items-center gap-2">
            ...
            <Button variant="light" className="border" onClick={handleReset}>
              Reset
            </Button>
        ...
        <div className="info-box d-flex gap-3">
          ...
          <div>
            ...
            <p style={{ fontSize: 13, color: "#7c3aed", margin: 0 }}>
              These parameters control how the AI responds to users across the
              entire platform. Lower temperature produces more consistent
              answers; higher values allow more creativity. Max tokens limits
              the length of each AI response.
            </p>
          </div>
        </div>
      </div>
