...
export async function getDocuments(params = {}) {
  return requestJson(`/documents${buildQuery(params)}`);
}
 ...
 * Backend chỉ tính Payments.status = 'paid' và cộng finalAmount.
 */
export async function getAdminRevenueStats() {
  return requestJson("/subscriptions/admin/revenue-stats");
}
